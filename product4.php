...
8-921-063-17-15
    ...
    <div class="product">
      <div class="tov">
        <img src="img/product4.jpg" width="220px" style="margin-left:-210px">
      </div>
        <div class="name" style="margin-top:-180px"><h3>Наборы для населения
        МЭТ-Скважина-1<br></h3>
        </div>
        <div class="text9" >Описание и предназначение данного товара:</div>
        <div class="ul">
            <li>Наборы для экспресс-анализа природных объектов в домашних условиях.</li>
            <li>Предназначены для определения качества питьевых вод различного происхождения.</li>
            <li>Питьевые, природные и очищенные воды.</li>
            <li>1 анализ на следующие компоненты: цветность, рН, жесткость, железо общ., 
                <br>железо(II), марганец, нитраты, нитриты, аммоний, фториды.</li>
               
            
            
            
        </div>
        <div class="block4" style="margin-top:10px">
          <h4 style="margin-left:70px">  1770 руб.</h4>
        </div>
        <div class="block2">
