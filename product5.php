...
8-921-063-17-15
    ...
    <div class="product">
      <div class="tov">
        <img src="img/product5.jpg" width="140px" >
      </div>
        <div class="name" style="margin-top:-180px"><h3>Системы обратного осмоса-99,9% очистки<br></h3>
        </div>
        ...
        <div class="ul">
            ...
            <li>Максимальная производительность - (140 … 200) л/сутки.</li>
            <li>Объем накопительного бака - 12 литров.</li>
            <li>ММатериал колб и постфильтра - полипропилен.</li>
